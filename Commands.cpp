...
float Printer::oldCode;
float Printer::newCode;
float Printer::new2Code;
uint8_t countVariable;
//float diffVari;
  ...
  if (com->hasE()){
    if (com->G == 1){
      if (Printer::relativeCoordinateMode == true){
        ...
        Printer::newECode += com->E - Printer::oldCode;
        Printer::oldCode = com->E;
      }
      countVariable++;
      if (countVariable == 10){
    ...
    /*if (com->hasE()){
      if (Printer::relativeCoordinateMode = true){
        ...
        diffVari = com->E - Printer::oldCode;
        Printer::newECode += diffVari;
        Printer::oldCode = com->E;
        HAL::eprSetFloat(0, Printer::newECode); 
      }
    }*/
	...
	case 92: { // G92
      ...
      if (Printer::convertToMM(com->E) == 0){
        //Printer::oldCode = 0;  
      }
		}
	}
