...
#define ENDSTOP_E0_MAX_ID 128         //Marcel Endstop
...
public:
...
#ifdef EXTENDED_ENDSTOPS
		return (lastState & (ENDSTOP_X_MAX_ID | ENDSTOP_Y_MAX_ID | ENDSTOP_Z_MAX_ID | ENDSTOP_X_MIN_ID | ENDSTOP_Y_MIN_ID | ENDSTOP_Z_MIN_ID | ENDSTOP_Z2_MIN_ID | ENDSTOP_E0_MAX_ID)) != 0 ||
			lastState2 != 0;
#else
		return (lastState & (ENDSTOP_X_MAX_ID | ENDSTOP_Y_MAX_ID | ENDSTOP_Z_MAX_ID | ENDSTOP_X_MIN_ID | ENDSTOP_Y_MIN_ID | ENDSTOP_Z_MIN_ID | ENDSTOP_Z2_MIN_ID | ENDSTOP_E0_MAX_ID)) != 0;
#endif
	...
	static INLINE bool e0Max() {                        //Marcel Endstop
#if (E0_MAX_PIN > -1) && MAX_HARDWARE_ENDSTOP_E0
		return (lastState2 & ENDSTOP_E0_MAX_ID) != 0;
#else
		return false;
#endif
	}
...
#endif
#endif
static uint8_t eMaxPos = 39; // max extruder pos
//static float newECode;
class Printer
{
...
public:
	...
	static int32_t eMaxSteps;                 //Marcel Endstop
  static float newECode;
  static float oldCode;
  static float newCode;
  static float new2Code;
	...
	static INLINE bool getE0Direction()               //Marcel Endstop
	{
		return((READ(EXT0_DIR_PIN) != 0) ^ EXT0_INVERSE);
	}
