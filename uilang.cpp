...
TRANS(UI_TEXT_KARTUSCHENW_EN);  //marcel Kartuschenwechsel
TRANS(UI_TEXT_ACTION_KARTUSCHENW_EN);
TRANS(UI_TEXT_ACTION_KARTUSCHENW2_EN);
TRANS(UI_TEXT_PREHEAT_WAIT_EN);
TRANS(UI_TEXT_ACTION_KARTUSCHENW_2_EN);
TRANS(UI_TEXT_ACTION_KARTUSCHENW_3_EN);
TRANS(UI_TEXT_SKIP_EN);
TRANS(UI_TEXT_PREHEAT_ASK_EN);
TRANS(UI_TEXT_PREHEAT_DONE_EN);
TRANS(UI_TEXT_CALIBRATE_EN);
TRANS(UI_TEXT_CALIBRATE_NOW_EN);
TRANS(UI_TEXT_NO_ALREADY_EN);
TRANS(UI_TEXT_CHOCO_EN);
TRANS(UI_TEXT_TEXT_EN);
TRANS(UI_TEXT_CHOCO_NOW_EN);
TRANS(UI_TEXT_CLEAN_EN);
TRANS(UI_TEXT_CLEAN_1_EN);
TRANS(UI_TEXT_CLEAN_2_EN);
TRANS(UI_TEXT_CLEAN_3_EN);
TRANS(UI_TEXT_CLEAN_4_EN);
TRANS(UI_TEXT_SKIP_PRE_EN);
TRANS(UI_TEXT_SKIP_SURE_EN);
TRANS(UI_TEXT_NO_SD_1_EN);
TRANS(UI_TEXT_NO_SD_2_EN);
TRANS(UI_TEXT_NO_SD_3_EN);
TRANS(UI_TEXT_EXTRUDE_1_EN);
TRANS(UI_TEXT_EXTRUDE_2_EN);
TRANS(UI_TEXT_CALIBRATE_1_EN);
TRANS(UI_TEXT_CALIBRATE_2_EN);
TRANS(UI_TEXT_COOKIE_EN);
TRANS(UI_TEXT_CHOCOLATE_EN);
TRANS(UI_TEXT_STANDARD_EN);
TRANS(UI_TEXT_PLACE_PLATE_1_EN);
TRANS(UI_TEXT_PLACE_PLATE_2_EN);
TRANS(UI_TEXT_PRE_CALIBRATE_EN);
TRANS(UI_TEXT_CALIBRATE_3_EN);
TRANS(UI_TEXT_CALIBRATE_4_EN);
TRANS(UI_TEXT_TEMP_DEFECT_EN);
TRANS(UI_TEXT_SKIP_2_EN);
TRANS(UI_TEXT_SKIP_3_EN);
TRANS(UI_TEXT_KARTUSCHENR_EN);
TRANS(UI_TEXT_KARTUSCHENR_CHOOSE_EN);
TRANS(UI_TEXT_CLEAN_PRE_EN);
TRANS(UI_TEXT_SERVICE_EN);
TRANS(UI_TEXT_SERVICE_1_EN);
TRANS(UI_TEXT_SERVICE_2_EN);
TRANS(UI_TEXT_SERVICE_3_EN);
TRANS(UI_TEXT_ERROR_TEXT_EN);
TRANS(UI_TEXT_ERROR_TEMP_EN);
TRANS(UI_TEXT_MYCUSINI_EN);
TRANS(UI_TEXT_REFILL_EN);
TRANS(UI_TEXT_TEMPERATURE_EN);
TRANS(UI_TEXT_EXTR_UP_EN);
TRANS(UI_TEXT_EXTR_DOWN_EN);
TRANS(UI_TEXT_CART_1_NEW_EN);
TRANS(UI_TEXT_CART_IN_EN);
TRANS(UI_TEXT_START_QUEST_EN);
TRANS(UI_TEXT_ABORT_EN);
TRANS(UI_TEXT_TURN_OFF_EN);
TRANS(UI_TEXT_DONE_QUEST_EN);
TRANS(UI_TEXT_INSERT_NEW_CART_EN);
TRANS(UI_TEXT_CARTRIDGE_REMOVE_EN);
TRANS(UI_TEXT_TURN_OFF_LAST_EN);
TRANS(UI_TEXT_TURN_OFF_LAST_2_EN);
TRANS(UI_TEXT_TURN_OFF_LAST_3_EN);
TRANS(UI_TEXT_REMOVE_FIRST_EN);
TRANS(UI_TEXT_ANOTHER_EN);
TRANS(UI_TEXT_READY_EN);
TRANS(UI_TEXT_INSERT_STAMP_EN);
TRANS(UI_TEXT_CART_IN_2_EN);
TRANS(UI_TEXT_DONE_EN);
TRANS(UI_TEXT_WAIT_EN);
TRANS(UI_TEXT_PREHEATING_EN);
TRANS(UI_TEXT_PREDOSE_EXTRA_EN);
TRANS(UI_TEXT_LOAD_CHOCO_EN);
TRANS(UI_TEXT_LOAD_CHOCO_NOW_EN);
TRANS(UI_TEXT_CLICK_START_EN);
TRANS(UI_TEXT_LOAD_CHOCO_DONE_EN);
TRANS(UI_TEXT_TURN_OFF_MENU_EN);
TRANS(UI_TEXT_TURN_OFF_MENU1_EN);
TRANS(UI_TEXT_CARTRIDGE_REMOVE_2_EN);
TRANS(UI_TEXT_YES_CLEAN_NOW_EN);
TRANS(UI_TEXT_REMOVED_EN);
TRANS(UI_TEXT_WAIT_EXTRUDER_DOWN_1_EN);
TRANS(UI_TEXT_WAIT_EXTRUDER_DOWN_2_EN);
TRANS(UI_TEXT_WAIT_EXTRUDER_UP_1_EN);
TRANS(UI_TEXT_DONE_CLEANING_EN);
TRANS(UI_TEXT_CLOSE_CART_1_EN);
TRANS(UI_TEXT_CLOSE_CART_2_EN);
TRANS(UI_TEXT_NO_ABORT_EN);
TRANS(UI_TEXT_NO_MENU_EN);
TRANS(UI_TEXT_STOP_EXTRUDE_EN);
TRANS(UI_TEXT_EMPTY_CART_1_EN);
TRANS(UI_TEXT_EMPTY_CART_2_EN);
TRANS(UI_TEXT_EMPTY_CART_3_EN);
TRANS(UI_TEXT_EMPTY_CART_4_EN);
TRANS(UI_TEXT_MAINT_EN);
TRANS(UI_TEXT_VERSION_1_EN);
TRANS(UI_TEXT_VERSION_2_EN);
TRANS(UI_TEXT_VERSION_3_EN);
TRANS(UI_TEXT_CALI_1_EN);
TRANS(UI_TEXT_CALI_2_EN);
TRANS(UI_TEXT_CALI_3_EN);
TRANS(UI_TEXT_CALI_4_EN);
TRANS(UI_TEXT_CALI_5_EN);
TRANS(UI_TEXT_CALI_6_EN);
TRANS(UI_TEXT_CLEAN_EX_1_EN);
TRANS(UI_TEXT_CLEAN_EX_2_EN);
TRANS(UI_TEXT_CLEAN_EX_3_EN);
TRANS(UI_TEXT_CLEAN_EX_4_EN);
TRANS(UI_TEXT_CLEAN_EX_5_EN);
TRANS(UI_TEXT_HELP_1_EN);
TRANS(UI_TEXT_HELP_2_EN);
TRANS(UI_TEXT_CALI_7_EN);
TRANS(UI_TEXT_CALI_8_EN);
TRANS(UI_TEXT_CLEAN_EX_6_EN);
TRANS(UI_TEXT_NEXT_ACTION_EN);
TRANS(UI_TEXT_CLEAN_GO_EN);
TRANS(UI_TEXT_CALI_PRE_1_EN);
TRANS(UI_TEXT_START_NEW_1_EN);
TRANS(UI_TEXT_START_NEW_2_EN);
TRANS(UI_TEXT_CHOOSE_OBJECT_EN);
TRANS(UI_TEXT_PRODUCE_ASK_1_EN);
TRANS(UI_TEXT_PRODUCE_ASK_2_EN);
TRANS(UI_TEXT_LANG_CHOOSE_1_EN);
TRANS(UI_TEXT_LANG_CHOOSE_2_EN);
TRANS(UI_TEXT_LANG_CHOOSE_3_EN);
TRANS(UI_TEXT_LANG_CHOOSE_4_EN);
TRANS(UI_TEXT_MAIN_TEMP_EN);
TRANS(UI_TEXT_MAIN_CLICK_EN);
TRANS(UI_TEXT_RESET_1_EN); 
TRANS(UI_TEXT_RESET_2_EN);
TRANS(UI_TEXT_RESET_3_EN);
TRANS(UI_TEXT_RESET_4_EN);
TRANS(UI_TEXT_TEMP_2_EN);
...
PGM_P const translations_en[NUM_TRANSLATED_WORDS] PROGMEM = {
 ...
 FUI_TEXT_KARTUSCHENW_EN,  //marcel Kartuschenwechsel
 FUI_TEXT_ACTION_KARTUSCHENW_EN,
 FUI_TEXT_ACTION_KARTUSCHENW2_EN,
 FUI_TEXT_PREHEAT_WAIT_EN,
 FUI_TEXT_ACTION_KARTUSCHENW_2_EN,  // marcel menu
 FUI_TEXT_ACTION_KARTUSCHENW_3_EN,
 FUI_TEXT_SKIP_EN,
 FUI_TEXT_PREHEAT_ASK_EN,
 FUI_TEXT_PREHEAT_DONE_EN,
 FUI_TEXT_CALIBRATE_EN,
 FUI_TEXT_CALIBRATE_NOW_EN,
 FUI_TEXT_NO_ALREADY_EN,
 FUI_TEXT_CHOCO_EN,
 FUI_TEXT_TEXT_EN,
 FUI_TEXT_CHOCO_NOW_EN,
 FUI_TEXT_CLEAN_EN,
 FUI_TEXT_CLEAN_1_EN,
 FUI_TEXT_CLEAN_2_EN,
 FUI_TEXT_CLEAN_3_EN,
 FUI_TEXT_CLEAN_4_EN,
 FUI_TEXT_SKIP_PRE_EN,
 FUI_TEXT_SKIP_SURE_EN,
 FUI_TEXT_NO_SD_1_EN,
 FUI_TEXT_NO_SD_2_EN,
 FUI_TEXT_NO_SD_3_EN,
 FUI_TEXT_EXTRUDE_1_EN,
 FUI_TEXT_EXTRUDE_2_EN,
 FUI_TEXT_CALIBRATE_1_EN,
 FUI_TEXT_CALIBRATE_2_EN,
 FUI_TEXT_COOKIE_EN,
 FUI_TEXT_CHOCOLATE_EN,
 FUI_TEXT_STANDARD_EN,
 FUI_TEXT_PLACE_PLATE_1_EN,
 FUI_TEXT_PLACE_PLATE_2_EN,
 FUI_TEXT_PRE_CALIBRATE_EN,
 FUI_TEXT_CALIBRATE_3_EN,
 FUI_TEXT_CALIBRATE_4_EN,
 FUI_TEXT_TEMP_DEFECT_EN,
 FUI_TEXT_SKIP_2_EN,
 FUI_TEXT_SKIP_3_EN,
 FUI_TEXT_KARTUSCHENR_EN,
 FUI_TEXT_KARTUSCHENR_CHOOSE_EN,
 FUI_TEXT_CLEAN_PRE_EN,
 FUI_TEXT_SERVICE_EN,
 FUI_TEXT_SERVICE_1_EN,
 FUI_TEXT_SERVICE_2_EN,
 FUI_TEXT_SERVICE_3_EN,
 FUI_TEXT_ERROR_TEXT_EN,
 FUI_TEXT_ERROR_TEMP_EN,
 FUI_TEXT_MYCUSINI_EN,
 FUI_TEXT_REFILL_EN,
 FUI_TEXT_TEMPERATURE_EN,
 FUI_TEXT_EXTR_UP_EN,
 FUI_TEXT_EXTR_DOWN_EN,
 FUI_TEXT_CART_1_NEW_EN,
 FUI_TEXT_CART_IN_EN,
 FUI_TEXT_START_QUEST_EN,
 FUI_TEXT_ABORT_EN,
 FUI_TEXT_TURN_OFF_EN,
 FUI_TEXT_DONE_QUEST_EN,
 FUI_TEXT_INSERT_NEW_CART_EN,
 FUI_TEXT_CARTRIDGE_REMOVE_EN,
 FUI_TEXT_TURN_OFF_LAST_EN,
 FUI_TEXT_TURN_OFF_LAST_2_EN,
 FUI_TEXT_TURN_OFF_LAST_3_EN,
 FUI_TEXT_REMOVE_FIRST_EN,
 FUI_TEXT_ANOTHER_EN,
 FUI_TEXT_READY_EN,
 FUI_TEXT_INSERT_STAMP_EN,
 FUI_TEXT_CART_IN_2_EN,
 FUI_TEXT_DONE_EN,
 FUI_TEXT_WAIT_EN,
 FUI_TEXT_PREHEATING_EN,
 FUI_TEXT_PREDOSE_EXTRA_EN,
 FUI_TEXT_LOAD_CHOCO_EN,
 FUI_TEXT_LOAD_CHOCO_NOW_EN,
 FUI_TEXT_CLICK_START_EN,
 FUI_TEXT_LOAD_CHOCO_DONE_EN,
 FUI_TEXT_TURN_OFF_MENU_EN,
 FUI_TEXT_TURN_OFF_MENU1_EN,
 FUI_TEXT_CARTRIDGE_REMOVE_2_EN,
 FUI_TEXT_YES_CLEAN_NOW_EN,
 FUI_TEXT_REMOVED_EN,
 FUI_TEXT_WAIT_EXTRUDER_DOWN_1_EN,
 FUI_TEXT_WAIT_EXTRUDER_DOWN_2_EN,
 FUI_TEXT_WAIT_EXTRUDER_UP_1_EN,
 FUI_TEXT_DONE_CLEANING_EN,
 FUI_TEXT_CLOSE_CART_1_EN,
 FUI_TEXT_CLOSE_CART_2_EN,
 FUI_TEXT_NO_ABORT_EN,
 FUI_TEXT_NO_MENU_EN,
 FUI_TEXT_STOP_EXTRUDE_EN,
 FUI_TEXT_EMPTY_CART_1_EN,
 FUI_TEXT_EMPTY_CART_2_EN,
 FUI_TEXT_EMPTY_CART_3_EN,
 FUI_TEXT_EMPTY_CART_4_EN,
 FUI_TEXT_MAINT_EN,
 FUI_TEXT_VERSION_1_EN,
 FUI_TEXT_VERSION_2_EN,
 FUI_TEXT_VERSION_3_EN,
 FUI_TEXT_CALI_1_EN,
 FUI_TEXT_CALI_2_EN,
 FUI_TEXT_CALI_3_EN,
 FUI_TEXT_CALI_4_EN,
 FUI_TEXT_CALI_5_EN,
 FUI_TEXT_CALI_6_EN,
 FUI_TEXT_CLEAN_EX_1_EN,
 FUI_TEXT_CLEAN_EX_2_EN,
 FUI_TEXT_CLEAN_EX_3_EN,
 FUI_TEXT_CLEAN_EX_4_EN,
 FUI_TEXT_CLEAN_EX_5_EN,
 FUI_TEXT_HELP_1_EN,
 FUI_TEXT_HELP_2_EN,
 FUI_TEXT_CALI_7_EN,
 FUI_TEXT_CALI_8_EN,
 FUI_TEXT_CLEAN_EX_6_EN,
 FUI_TEXT_NEXT_ACTION_EN,
 FUI_TEXT_CLEAN_GO_EN,
 FUI_TEXT_CALI_PRE_1_EN,
 FUI_TEXT_START_NEW_1_EN,
 FUI_TEXT_START_NEW_2_EN,
 FUI_TEXT_CHOOSE_OBJECT_EN,
 FUI_TEXT_PRODUCE_ASK_1_EN,
 FUI_TEXT_PRODUCE_ASK_2_EN,
 FUI_TEXT_LANG_CHOOSE_1_EN,
 FUI_TEXT_LANG_CHOOSE_2_EN,
 FUI_TEXT_LANG_CHOOSE_3_EN,
 FUI_TEXT_LANG_CHOOSE_4_EN,
 FUI_TEXT_MAIN_TEMP_EN,
 FUI_TEXT_MAIN_CLICK_EN,
 FUI_TEXT_RESET_1_EN,
 FUI_TEXT_RESET_2_EN,
 FUI_TEXT_RESET_3_EN,
 FUI_TEXT_RESET_4_EN,
...
TRANS(UI_TEXT_KARTUSCHENW_DE);
TRANS(UI_TEXT_ACTION_KARTUSCHENW_DE);
TRANS(UI_TEXT_ACTION_KARTUSCHENW2_DE);
TRANS(UI_TEXT_PREHEAT_WAIT_DE);
TRANS(UI_TEXT_ACTION_KARTUSCHENW_2_DE);
TRANS(UI_TEXT_ACTION_KARTUSCHENW_3_DE);
TRANS(UI_TEXT_SKIP_DE);
TRANS(UI_TEXT_PREHEAT_ASK_DE);
TRANS(UI_TEXT_PREHEAT_DONE_DE);
TRANS(UI_TEXT_CALIBRATE_DE);
TRANS(UI_TEXT_CALIBRATE_NOW_DE);
TRANS(UI_TEXT_NO_ALREADY_DE);
TRANS(UI_TEXT_CHOCO_DE);
TRANS(UI_TEXT_TEXT_DE);
TRANS(UI_TEXT_CHOCO_NOW_DE);
TRANS(UI_TEXT_CLEAN_DE);
TRANS(UI_TEXT_CLEAN_1_DE);
TRANS(UI_TEXT_CLEAN_2_DE);
TRANS(UI_TEXT_CLEAN_3_DE);
TRANS(UI_TEXT_CLEAN_4_DE);
TRANS(UI_TEXT_SKIP_PRE_DE);
TRANS(UI_TEXT_SKIP_SURE_DE);
TRANS(UI_TEXT_NO_SD_1_DE);
TRANS(UI_TEXT_NO_SD_2_DE);
TRANS(UI_TEXT_NO_SD_3_DE);
TRANS(UI_TEXT_EXTRUDE_1_DE);
TRANS(UI_TEXT_EXTRUDE_2_DE);
TRANS(UI_TEXT_CALIBRATE_1_DE);
TRANS(UI_TEXT_CALIBRATE_2_DE);
TRANS(UI_TEXT_COOKIE_DE);
TRANS(UI_TEXT_CHOCOLATE_DE);
TRANS(UI_TEXT_STANDARD_DE);
TRANS(UI_TEXT_PLACE_PLATE_1_DE);
TRANS(UI_TEXT_PLACE_PLATE_2_DE);
TRANS(UI_TEXT_PRE_CALIBRATE_DE);
TRANS(UI_TEXT_CALIBRATE_3_DE);
TRANS(UI_TEXT_CALIBRATE_4_DE);
TRANS(UI_TEXT_TEMP_DEFECT_DE);
TRANS(UI_TEXT_SKIP_2_DE);
TRANS(UI_TEXT_SKIP_3_DE);
TRANS(UI_TEXT_KARTUSCHENR_DE);
TRANS(UI_TEXT_KARTUSCHENR_CHOOSE_DE);
TRANS(UI_TEXT_CLEAN_PRE_DE);
TRANS(UI_TEXT_SERVICE_DE);
TRANS(UI_TEXT_SERVICE_1_DE);
TRANS(UI_TEXT_SERVICE_2_DE);
TRANS(UI_TEXT_SERVICE_3_DE);
TRANS(UI_TEXT_ERROR_TEXT_DE);
TRANS(UI_TEXT_ERROR_TEMP_DE);
TRANS(UI_TEXT_MYCUSINI_DE);
TRANS(UI_TEXT_REFILL_DE);
TRANS(UI_TEXT_TEMPERATURE_DE);
TRANS(UI_TEXT_EXTR_UP_DE);
TRANS(UI_TEXT_EXTR_DOWN_DE);
TRANS(UI_TEXT_CART_1_NEW_DE);
TRANS(UI_TEXT_CART_IN_DE);
TRANS(UI_TEXT_CART_IN_2_DE);
TRANS(UI_TEXT_START_QUEST_DE);
TRANS(UI_TEXT_ABORT_DE);
TRANS(UI_TEXT_TURN_OFF_DE);
TRANS(UI_TEXT_DONE_QUEST_DE);
TRANS(UI_TEXT_INSERT_NEW_CART_DE);
TRANS(UI_TEXT_CARTRIDGE_REMOVE_DE);
TRANS(UI_TEXT_CARTRIDGE_REMOVE_2_DE);
TRANS(UI_TEXT_TURN_OFF_LAST_DE);
TRANS(UI_TEXT_TURN_OFF_LAST_2_DE);
TRANS(UI_TEXT_TURN_OFF_LAST_3_DE);
TRANS(UI_TEXT_REMOVE_FIRST_DE);
TRANS(UI_TEXT_ANOTHER_DE);
TRANS(UI_TEXT_READY_DE);
TRANS(UI_TEXT_INSERT_STAMP_DE);
TRANS(UI_TEXT_DONE_DE);
TRANS(UI_TEXT_WAIT_DE);
TRANS(UI_TEXT_PREHEATING_DE);
TRANS(UI_TEXT_PREDOSE_EXTRA_DE);
TRANS(UI_TEXT_LOAD_CHOCO_DE);
TRANS(UI_TEXT_LOAD_CHOCO_NOW_DE);
TRANS(UI_TEXT_CLICK_START_DE);
TRANS(UI_TEXT_LOAD_CHOCO_DONE_DE);
TRANS(UI_TEXT_TURN_OFF_MENU_DE);
TRANS(UI_TEXT_TURN_OFF_MENU1_DE);
TRANS(UI_TEXT_YES_CLEAN_NOW_DE);
TRANS(UI_TEXT_REMOVED_DE);
TRANS(UI_TEXT_WAIT_EXTRUDER_DOWN_1_DE);
TRANS(UI_TEXT_WAIT_EXTRUDER_DOWN_2_DE);
TRANS(UI_TEXT_WAIT_EXTRUDER_UP_1_DE);
TRANS(UI_TEXT_DONE_CLEANING_DE);
TRANS(UI_TEXT_CLOSE_CART_1_DE);
TRANS(UI_TEXT_CLOSE_CART_2_DE);
TRANS(UI_TEXT_NO_ABORT_DE);
TRANS(UI_TEXT_NO_MENU_DE);
TRANS(UI_TEXT_STOP_EXTRUDE_DE);
TRANS(UI_TEXT_EMPTY_CART_1_DE);
TRANS(UI_TEXT_EMPTY_CART_2_DE);
TRANS(UI_TEXT_EMPTY_CART_3_DE);
TRANS(UI_TEXT_EMPTY_CART_4_DE);
TRANS(UI_TEXT_MAINT_DE);
TRANS(UI_TEXT_VERSION_1_DE);
TRANS(UI_TEXT_VERSION_2_DE);
TRANS(UI_TEXT_VERSION_3_DE);
TRANS(UI_TEXT_CALI_1_DE);
TRANS(UI_TEXT_CALI_2_DE);
TRANS(UI_TEXT_CALI_3_DE);
TRANS(UI_TEXT_CALI_4_DE);
TRANS(UI_TEXT_CALI_5_DE);
TRANS(UI_TEXT_CALI_6_DE);
TRANS(UI_TEXT_CLEAN_EX_1_DE);
TRANS(UI_TEXT_CLEAN_EX_2_DE);
TRANS(UI_TEXT_CLEAN_EX_3_DE);
TRANS(UI_TEXT_CLEAN_EX_4_DE);
TRANS(UI_TEXT_CLEAN_EX_5_DE);
TRANS(UI_TEXT_HELP_1_DE);
TRANS(UI_TEXT_HELP_2_DE);
TRANS(UI_TEXT_CALI_7_DE);
TRANS(UI_TEXT_CALI_8_DE);
TRANS(UI_TEXT_CLEAN_EX_6_DE);
TRANS(UI_TEXT_NEXT_ACTION_DE);
TRANS(UI_TEXT_CLEAN_GO_DE);
TRANS(UI_TEXT_CALI_PRE_1_DE);
TRANS(UI_TEXT_START_NEW_1_DE);
TRANS(UI_TEXT_START_NEW_2_DE);
TRANS(UI_TEXT_CHOOSE_OBJECT_DE);
TRANS(UI_TEXT_PRODUCE_ASK_1_DE);
TRANS(UI_TEXT_PRODUCE_ASK_2_DE);
TRANS(UI_TEXT_LANG_CHOOSE_1_DE);
TRANS(UI_TEXT_LANG_CHOOSE_2_DE);
TRANS(UI_TEXT_LANG_CHOOSE_3_DE);
TRANS(UI_TEXT_LANG_CHOOSE_4_DE);
TRANS(UI_TEXT_MAIN_TEMP_DE);
TRANS(UI_TEXT_MAIN_CLICK_DE);
TRANS(UI_TEXT_RESET_1_DE);
TRANS(UI_TEXT_RESET_2_DE);
TRANS(UI_TEXT_RESET_3_DE);
TRANS(UI_TEXT_RESET_4_DE);
TRANS(UI_TEXT_TEMP_2_DE);
...
PGM_P const translations_de[NUM_TRANSLATED_WORDS] PROGMEM = {
 ...
 FUI_TEXT_KARTUSCHENW_DE,
 FUI_TEXT_ACTION_KARTUSCHENW_DE,
 FUI_TEXT_ACTION_KARTUSCHENW2_DE,
 FUI_TEXT_PREHEAT_WAIT_DE,
 FUI_TEXT_ACTION_KARTUSCHENW_2_DE,
 FUI_TEXT_ACTION_KARTUSCHENW_3_DE,
 FUI_TEXT_SKIP_DE,
 FUI_TEXT_PREHEAT_ASK_DE,
 FUI_TEXT_PREHEAT_DONE_DE,
 FUI_TEXT_CALIBRATE_DE,
 FUI_TEXT_CALIBRATE_NOW_DE,
 FUI_TEXT_NO_ALREADY_DE,
 FUI_TEXT_CHOCO_DE,
 FUI_TEXT_TEXT_DE,
 FUI_TEXT_CHOCO_NOW_DE,
 FUI_TEXT_CLEAN_DE,
 FUI_TEXT_CLEAN_1_DE,
 FUI_TEXT_CLEAN_2_DE,
 FUI_TEXT_CLEAN_3_DE,
 FUI_TEXT_CLEAN_4_DE,
 FUI_TEXT_SKIP_PRE_DE,
 FUI_TEXT_SKIP_SURE_DE,
 FUI_TEXT_NO_SD_1_DE,
 FUI_TEXT_NO_SD_2_DE,
 FUI_TEXT_NO_SD_3_DE,
 FUI_TEXT_EXTRUDE_1_DE,
 FUI_TEXT_EXTRUDE_2_DE,
 FUI_TEXT_CALIBRATE_1_DE,
 FUI_TEXT_CALIBRATE_2_DE,
 FUI_TEXT_COOKIE_DE,
 FUI_TEXT_CHOCOLATE_DE,
 FUI_TEXT_STANDARD_DE,
 FUI_TEXT_PLACE_PLATE_1_DE,
 FUI_TEXT_PLACE_PLATE_2_DE,
 FUI_TEXT_PRE_CALIBRATE_DE,
 FUI_TEXT_CALIBRATE_3_DE,
 FUI_TEXT_CALIBRATE_4_DE,
 FUI_TEXT_TEMP_DEFECT_DE,
 FUI_TEXT_SKIP_2_DE,
 FUI_TEXT_SKIP_3_DE,
 FUI_TEXT_KARTUSCHENR_DE,
 FUI_TEXT_KARTUSCHENR_CHOOSE_DE,
 FUI_TEXT_CLEAN_PRE_DE,
 FUI_TEXT_SERVICE_DE,
 FUI_TEXT_SERVICE_1_DE,
 FUI_TEXT_SERVICE_2_DE,
 FUI_TEXT_SERVICE_3_DE,
 FUI_TEXT_ERROR_TEXT_DE,
 FUI_TEXT_ERROR_TEMP_DE,
 FUI_TEXT_MYCUSINI_DE,
 FUI_TEXT_REFILL_DE,
 FUI_TEXT_TEMPERATURE_DE,
 FUI_TEXT_EXTR_UP_DE,
 FUI_TEXT_EXTR_DOWN_DE,
 FUI_TEXT_CART_1_NEW_DE,
 FUI_TEXT_CART_IN_DE,
 FUI_TEXT_START_QUEST_DE,
 FUI_TEXT_ABORT_DE,
 FUI_TEXT_TURN_OFF_DE,
 FUI_TEXT_DONE_QUEST_DE,
 FUI_TEXT_INSERT_NEW_CART_DE,
 FUI_TEXT_CARTRIDGE_REMOVE_DE,
 FUI_TEXT_TURN_OFF_LAST_DE,
 FUI_TEXT_TURN_OFF_LAST_2_DE,
 FUI_TEXT_TURN_OFF_LAST_3_DE,
 FUI_TEXT_REMOVE_FIRST_DE,
 FUI_TEXT_ANOTHER_DE,
 FUI_TEXT_READY_DE,
 FUI_TEXT_INSERT_STAMP_DE,
 FUI_TEXT_CART_IN_2_DE,
 FUI_TEXT_DONE_DE,
 FUI_TEXT_WAIT_DE,
 FUI_TEXT_PREHEATING_DE,
 FUI_TEXT_PREDOSE_EXTRA_DE,
 FUI_TEXT_LOAD_CHOCO_DE,
 FUI_TEXT_LOAD_CHOCO_NOW_DE,
 FUI_TEXT_CLICK_START_DE,
 FUI_TEXT_LOAD_CHOCO_DONE_DE,
 FUI_TEXT_TURN_OFF_MENU_DE,
 FUI_TEXT_TURN_OFF_MENU1_DE,
 FUI_TEXT_CARTRIDGE_REMOVE_2_DE,
 FUI_TEXT_YES_CLEAN_NOW_DE,
 FUI_TEXT_REMOVED_DE,
 FUI_TEXT_WAIT_EXTRUDER_DOWN_1_DE,
 FUI_TEXT_WAIT_EXTRUDER_DOWN_2_DE,
 FUI_TEXT_WAIT_EXTRUDER_UP_1_DE,
 FUI_TEXT_DONE_CLEANING_DE,
 FUI_TEXT_CLOSE_CART_1_DE,
 FUI_TEXT_CLOSE_CART_2_DE,
 FUI_TEXT_NO_ABORT_DE,
 FUI_TEXT_NO_MENU_DE,
 FUI_TEXT_STOP_EXTRUDE_DE,
 FUI_TEXT_EMPTY_CART_1_DE,
 FUI_TEXT_EMPTY_CART_2_DE,
 FUI_TEXT_EMPTY_CART_3_DE,
 FUI_TEXT_EMPTY_CART_4_DE,
 FUI_TEXT_MAINT_DE,
 FUI_TEXT_VERSION_1_DE,
 FUI_TEXT_VERSION_2_DE,
 FUI_TEXT_VERSION_3_DE,
 FUI_TEXT_CALI_1_DE,
 FUI_TEXT_CALI_2_DE,
 FUI_TEXT_CALI_3_DE,
 FUI_TEXT_CALI_4_DE,
 FUI_TEXT_CALI_5_DE,
 FUI_TEXT_CALI_6_DE,
 FUI_TEXT_CLEAN_EX_1_DE,
 FUI_TEXT_CLEAN_EX_2_DE,
 FUI_TEXT_CLEAN_EX_3_DE,
 FUI_TEXT_CLEAN_EX_4_DE,
 FUI_TEXT_CLEAN_EX_5_DE,
 FUI_TEXT_HELP_1_DE,
 FUI_TEXT_HELP_2_DE,
 FUI_TEXT_CALI_7_DE,
 FUI_TEXT_CALI_8_DE,
 FUI_TEXT_CLEAN_EX_6_DE,
 FUI_TEXT_NEXT_ACTION_DE,
 FUI_TEXT_CLEAN_GO_DE,
 FUI_TEXT_CALI_PRE_1_DE,
 FUI_TEXT_START_NEW_1_DE,
 FUI_TEXT_START_NEW_2_DE,
 FUI_TEXT_CHOOSE_OBJECT_DE,
 FUI_TEXT_PRODUCE_ASK_1_DE,
 FUI_TEXT_PRODUCE_ASK_2_DE,
 FUI_TEXT_LANG_CHOOSE_1_DE,
 FUI_TEXT_LANG_CHOOSE_2_DE,
 FUI_TEXT_LANG_CHOOSE_3_DE,
 FUI_TEXT_LANG_CHOOSE_4_DE,
 FUI_TEXT_MAIN_TEMP_DE,
 FUI_TEXT_MAIN_CLICK_DE,
 FUI_TEXT_RESET_1_DE,
 FUI_TEXT_RESET_2_DE,
 FUI_TEXT_RESET_3_DE,
 FUI_TEXT_RESET_4_DE,
