...
//Manuelle änderungen:
// Marcel Endstop
// = Einfügen des Extruder Max-Endstops
// Marcel Temp
// = Bedingung für den Test des Temperaturfühlers
// Marcel LCD
// = Einfügen des LCDs
// Marcel Kartuschenwechsel
// = Menüoption für den Kartuschenwechsel und Extruder Position als Öffnungsbedingung
// Marcel Menu
// = ändern und hinzufügen von Menüoptionen
...
void setup()
{
	...
	DEBUG_MESSAGE("=========================");
	DEBUG_MESSAGE_TWO("SDSS=", SDSS);
#endif
  for (int n = 0; n < sizeof(SetupDownPin) / sizeof(int); n++)
  {
    SET_OUTPUT(SetupDownPin[n]);
    WRITE(SetupDownPin[n], LOW);
  }
