...
enum debugFlags {
	DEB_ECHO = 0x1, DEB_INFO = 0x2, DEB_ERROR = 0x4, DEB_DRYRUN = 0x8,
...
#define CONTROLLER_MINI12864 61
...
#define YSTEP 32
#define ZSTEP 64
#define ESTEP 128 //marcel Endstop
//combo's
#define XYZ_STEP 112
#define XY_STEP 48
...
#ifndef SDCARDDETECT
#define SDCARDDETECT       PC4 //Marcel sd card -1
#endif
#ifndef SDSUPPORT
#define SDSUPPORT 0
#endif
