...
#define ORIG_E0_MAX              19   //Marcel Endstop
...
#define SDPOWER            -1
#define SDSS               53
#define ORIG_SDCARDDETECT 	    49  //marcel Sdcard

#define SDCARDDETECTINVERTED false // Marcel sdcard enable
...
#if MOTHERBOARD == 610
#ifndef MCU_STM32F103RE
#ifndef MCU_STM32F103RB
#error Oops!  Make sure you have 'Mini3200 Board' selected from the 'Tools -> Boards' menu.
#endif
#endif
...
#define ORIG_X_STEP_PIN     PC10
#define ORIG_X_DIR_PIN      PD2

#define ORIG_Y_STEP_PIN     PA8
#define ORIG_Y_DIR_PIN      PC8

#define ORIG_Z_STEP_PIN     PB15
#define ORIG_Z_DIR_PIN      PC6
#define ORIG_Z_MIN_PIN      PB10
#define ORIG_Z_MAX_PIN      PB10

#define ORIG_X_MIN_PIN      PA2
#define ORIG_X_MAX_PIN      PA2
#define ORIG_Y_MIN_PIN      PA3
#define ORIG_Y_MAX_PIN      PA3

#define ORIG_X_ENABLE_PIN   PA14
#define ORIG_Y_ENABLE_PIN   PA13
#define ORIG_Z_ENABLE_PIN   PC7

#define ORIG_E0_MAX	        PB7

// Heatbed
#define HEATER_0_PIN     PC1
// STM32 analog channel
#define TEMP_0_PIN       0
...
#define ORIG_E0_STEP_PIN    PC0
#define ORIG_E0_DIR_PIN     PB8
#define ORIG_E0_ENABLE_PIN  PA15

#define SDPOWER 	   -1

//Pause button pin
#define PAUSE_BUTTON_PIN -1

//light switch
#define LIGHT_SWITCH_PIN -1
// Using HW SPI.
#define SDSS		   PA4
...
#define LED_PIN 	   -1
#define ORIG_FAN_PIN 	   PC2
#define ORIG_FAN2_PIN       -1
#define ORIG_PS_ON_PIN      -1
#define PS_LOST_PIN         -1
#define KILL_PIN	   -1
#define SUICIDE_PIN    -1  //PIN that has to be turned on right after start, to keep power flowing.
...
#define EEPROM_AVAILABLE EEPROM_EMULATE
#endif
...
#define SENSITIVE_PINS {0, 1, ORIG_X_STEP_PIN, ORIG_X_DIR_PIN, ORIG_X_ENABLE_PIN, ORIG_X_MIN_PIN, ORIG_X_MAX_PIN, \
        ...
        HEATER_0_PIN, HEATER_1_PIN, ORIG_E0_MAX,ORIG_FAN_PIN, E0_PINS E1_PINS E2_PINS  TEMP_0_PIN, TEMP_1_PIN,SDSS }
